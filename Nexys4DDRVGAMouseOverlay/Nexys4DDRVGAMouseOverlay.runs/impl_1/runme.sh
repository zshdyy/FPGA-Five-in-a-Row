...
HD_PWD='E:/my_VHDL_project/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_ctrl.tcl -notrace
