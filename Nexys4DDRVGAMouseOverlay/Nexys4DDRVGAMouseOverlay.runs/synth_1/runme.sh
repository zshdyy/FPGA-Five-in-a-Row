...
HD_PWD='E:/my_VHDL_project/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay/Nexys4DDRVGAMouseOverlay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_ctrl.tcl
